...
function App() {
  ...
  const backgroundClass =
    pathname === '/' || pathsWhitBgBricks.some((path) => pathname.includes(path)) ? 'bg-bricks' : ''
        ...
        <CartContextProvider>
          ...
          <main className={backgroundClass}>
            <Routes>
              ...
              <Route path='/Productos/Categorias/:category' element={<Products />} />
              ...
              <Route index path='/Cuenta' element={<Account />} />
